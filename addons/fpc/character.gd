...
##  To do with Character Controller
##   	Slow movement, make it operate more like a video game fps controller wihtout the speed
##   	decrease the jump height after each jump and then have it recharge
##
##
##
